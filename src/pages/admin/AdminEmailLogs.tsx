      ...
      <div className="space-y-6">
        <div>
          <p className="text-sm text-muted-foreground">
            Dashboard / Settings / <span className="text-foreground font-medium">Logs Email</span>
          </p>
          <h1 className="text-xl font-semibold text-foreground mt-2">Logs Email</h1>
          <p className="text-sm text-muted-foreground">Historique des envois et erreurs — {total} envois</p>
        </div>
