...
import { ArrowLeft, Plus, Trash2, CheckCircle2, Clock, XCircle, Copy, Loader2 } from 'lucide-react';
    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">Authentification Domaine</h1>
            <p className="text-sm text-muted-foreground">DKIM / SPF — Vérification DNS</p>
          </div>
        </div>
